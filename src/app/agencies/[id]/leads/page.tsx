                        ...
                        {linkedStudents.length > 0 ? (
                            <div className="grid grid-cols-1 gap-3">
                                {linkedStudents.map(student => (
                                    <div key={student.id} className="flex items-center justify-between p-5 rounded-2xl border border-gray-100 bg-gray-50/50 hover:bg-white hover:shadow-md transition-all group">
                                        <div className="flex items-center gap-4">
                                            <div className="bg-amber-100 p-3 rounded-xl text-amber-600">
                                                <User size={20} />
                                            </div>
                                            <div>
                                                <h3 className="font-bold text-gray-900 text-lg group-hover:text-amber-600 transition-colors">{student.studentName}</h3>
                                        ...
                                        <div className="flex items-center gap-3">
                                            <button
                                                ...
                                                className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 text-gray-600 rounded-xl hover:bg-gray-50 font-bold text-xs transition-colors shadow-sm"
                                            >
                                                <Eye size={16} /> Quick View
                                            </button>
                                            <Link href={`/students/${student.id}`}>
                                                <button className="flex items-center gap-2 px-4 py-2 bg-black text-white rounded-xl hover:bg-gray-800 font-bold text-xs transition-colors shadow-lg">
                            ...
                            <div className="flex flex-col items-center justify-center py-16 text-center">
                                ...
                                <p className="text-gray-900 font-bold text-lg">No active leads found</p>
                                <p className="text-gray-500 text-sm mt-1">This agency has no students linked currently.</p>
                            </div>
                        )}
                    </div>
                </div>
