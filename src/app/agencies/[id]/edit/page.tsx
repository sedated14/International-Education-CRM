        ...
        <div className="flex h-screen bg-[#F0F2F5] text-[#1D1D1F] overflow-hidden font-sans">
            ...
            <main className="flex-1 flex flex-col h-screen overflow-y-auto">
                ...
                <header className="bg-white border-b border-gray-200 px-8 py-6 flex items-center gap-4 z-20 sticky top-0">
                    <Link href={`/agencies/${params.id}`} className="p-2 hover:bg-gray-100 rounded-full transition-colors text-gray-500">
                        <ArrowLeft size={20} />
                    </Link>
                    <div>
                        <h1 className="text-2xl font-black text-gray-900">Edit Agency</h1>
                        <p className="text-gray-500 font-medium text-sm">Update profile information for {agency.name}</p>
                    </div>
